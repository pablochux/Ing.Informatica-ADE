...
{Programa que encuentra el caracter que previamente has introducido y te dice si aparece}
CONST
	MIN = 1;
	MAX = 10;
...
BEGIN
	...
	IF (encontrado) THEN
	BEGIN
		writeln('El valor j ha sido encontrado.');
	END
	ELSE
	BEGIN
		writeln('El valor j no ha sido encontrado');
	END;
END.
