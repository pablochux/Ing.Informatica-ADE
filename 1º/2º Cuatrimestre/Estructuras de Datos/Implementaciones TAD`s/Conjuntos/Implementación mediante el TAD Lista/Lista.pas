{**************************************************************************
* Modulo: TAD Lista                  									  *
* Tipo: Programa(x) Interfaz-Implementacion TAD Lista(práctica 2)   	  *
* Autor: Pablo Alonso                                                     *
* Fecha: 2015                                                             *
...
INTERFACE
	...
	PROCEDURE BorrarElemento(VAR l: TLista; e: TInfo); {O(n)}
	...
	PROCEDURE InsertarFinal(VAR l: TLista; e: TInfo); {O(n)}
	{Pre = recibe una lista que puede ser vacía o no}
